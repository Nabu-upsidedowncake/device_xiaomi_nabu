...
/**
 * Fragment that displays the Doze settings screen, allowing the user to enable/disable Doze mode,
 * Always On Display, and the Pick Up gesture. It also shows a help dialog the first time the user
 * opens the screen.
 */
