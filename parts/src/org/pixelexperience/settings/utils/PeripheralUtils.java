...
import static org.pixelexperience.settings.stylus.StylusSettingsFragment.SHARED_STYLUS;
import static org.pixelexperience.settings.keyboard.XiaomiKeyboardSettingsFragment.SHARED_KEYBOARD;
import static org.pixelexperience.settings.tap2wake.Tap2WakeSettingsFragment.SHARED_TAP2WAKE;

/**
 * This class provides utility methods for managing peripheral devices such as stylus, keyboard, and tap2wake.
 * It initializes shared preferences for stylus, keyboard, and tap2wake, and syncs their states with the hardware state manager.
 */
