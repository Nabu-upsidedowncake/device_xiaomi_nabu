...
/**
 * This class represents the fragment for Dirac sound settings. It allows the user to enable/disable
 * Dirac sound enhancement, select the headset type, choose a preset, and enable/disable HiFi mode.
 * The class implements OnPreferenceChangeListener and OnMainSwitchChangeListener to handle preference changes.
 */
